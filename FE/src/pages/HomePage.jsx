    ...
    <>
      <section className="slider__area slider__area-3 p-relative">
              <div className="slider-active">
                  <div className="single-slider single-slider-2 slider__height-5 d-flex align-items-center" style={{ backgroundImage: `url(${sliderImage})`}}>
                      <div className="container-fluid">
                          <div className="row">
                              <div className="col-xl-6 col-lg-7 col-md-10">
                                  <div className="slider__content slider__content-3 pl-250">
                                      <h2 data-animation="fadeInUp" data-delay=".2s">Handmade</h2>
                  ...
                  <div className="product__item">
                    <div className="product__wrapper mb-60">
                      <div className="product__thumb">
                        ...
                        >
                          <img
                            src={`${item.productImages[0].productImagesUrl}/${item.productImages[0].productImagesName}`}
                            alt="Product Image"
                          />
                        </a>
